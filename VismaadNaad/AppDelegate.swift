...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        UITabBar.appearance().barTintColor = Colors.tabColor
        keyboardSettings()
        if UserDefaults.standard.double(forKey: UserDefaultsKey.zoomLevel) == 0.0 {
            registerDefaultSettings()
        }//com.googleusercontent.apps.771887573638-l6vk6d2cropeockiujrhs9hodmams9k5
        GIDSignIn.sharedInstance().clientID = "771887573638-l6vk6d2cropeockiujrhs9hodmams9k5.apps.googleusercontent.com"
    ...
    func application(_ app: UIApplication, open url: URL, options: [UIApplicationOpenURLOptionsKey : Any] = [:]) -> Bool {
        ...
        else if FBSDKApplicationDelegate.sharedInstance().application(app, open: url, sourceApplication: options[.sourceApplication] as? String, annotation: options[.annotation]) {
            return true
        }
        return false
    }
